...
class EarlyStopping_(EarlyStopping):
    ...
    def __init__(self,monitor ="val_loss",min_delta = 0.01,patience = 10,
                verbose= False,
                mode = "min",
                strict = True,
                check_finite = True,
        ...
        super(EarlyStopping_, self).__init__(monitor ,min_delta ,patience ,verbose,mode ,strict ,check_finite ,stopping_threshold,divergence_threshold ,check_on_train_epoch_end)
